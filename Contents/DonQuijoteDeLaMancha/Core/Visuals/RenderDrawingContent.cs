...
public abstract class RenderDrawingContent : ModType // , IRenderDrawingContentUpdatable
{
    ...
    {
        spriteBatch.Begin(SpriteSortMode.Immediate, BlendStateLibrary.NonPremultipliedFullAlpha, SamplerState.AnisotropicClamp, DepthStencilState.Default, RasterizerState.CullNone, null, RenderCanvasSystem.TransformationMatrix);
    }
